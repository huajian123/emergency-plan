                    ...
                    children: [
                        {
                            ...
                            open: false,
                            selected: false,
                            path: '/hazard-regional-response/local-emergency/public-health-event-first',
                        },
                        {
                            title: '二级灾害',
                            open: false,
                            selected: false,
                            path: '/hazard-regional-response/local-emergency/public-health-event-second',
                        },
                        {
                            title: '三级灾害',
                            open: false,
                            selected: false,
                            path: '/hazard-regional-response/local-emergency/public-health-event-third',
                        },
                        {
                            title: '四级灾害',
                            open: false,
                            selected: false,
                            path: '/hazard-regional-response/local-emergency/public-health-event-fourth',
                        },
                    ]
                },
                {
