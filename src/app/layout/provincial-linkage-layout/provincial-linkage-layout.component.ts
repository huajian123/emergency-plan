    ...
    menus: Menu[] = [
        {
            ...
            open: false,
            selected: false,
            path: '/hazard-provincial/provincial-linkage/total-plan-pro',
        },
        {
            title: '自然灾害类',
            icon: 'iconnatura',
                    ...
                    children: [
                        {
                            ...
                            open: false,
                            selected: false,
                            path: '/hazard-provincial/provincial-linkage/hazardous-food-pro-first',
                        },
                        {
                            title: '二级灾害',
                            open: false,
                            selected: false,
                            path: '/hazard-provincial/provincial-linkage/hazardous-food-pro-second',
                        },
                        {
                            title: '三级灾害',
                            open: false,
                            selected: false,
                            path: '/hazard-provincial/provincial-linkage/hazardous-food-pro-third',
                        },
                        {
                            title: '四级灾害',
                            open: false,
                            selected: false,
                            path: '/hazard-provincial/provincial-linkage/hazardous-food-pro-fourth',
                        },
                    ]
                },
                {
