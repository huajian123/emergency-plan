...
@Component({
  selector: 'app-earth-level-three',
  templateUrl: './earth-level-three.component.html',
  styleUrls: ['./earth-level-three.component.less']
})
export class EarthLevelThreeComponent implements OnInit {
