...
export class SecondPriceChangesComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.PriceChanges).subscribe(res => {
            this.dataInfo = res;
