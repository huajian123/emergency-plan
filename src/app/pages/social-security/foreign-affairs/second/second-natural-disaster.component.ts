...
export class SecondForeignAffairsComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.ForeignAffairs).subscribe(res => {
            this.dataInfo = res;
