...
export class SecondReliefSuppliesComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.ReliefSupplies).subscribe(res => {
            this.dataInfo = res;
