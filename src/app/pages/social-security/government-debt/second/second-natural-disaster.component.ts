...
export class SecondGovernmentDebtComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.GovernmentDebt).subscribe(res => {
            this.dataInfo = res;
