...
export class SecondTerroristAttacksComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.TerroristAttacks).subscribe(res => {
            this.dataInfo = res;
