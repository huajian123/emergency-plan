...
export class SecondNetworkInformationSecurityComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.NetworkInformationSecurity).subscribe(res => {
            this.dataInfo = res;
