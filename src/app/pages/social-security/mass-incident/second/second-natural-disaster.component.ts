...
export class SecondMassIncidentComponent implements OnInit {
    ...
    async getSocialSecurityDetail() {
        await this.dataService.getSocialSecurityList(this.socialSecurityEnum.MassIncident).subscribe(res => {
            this.dataInfo = res;
