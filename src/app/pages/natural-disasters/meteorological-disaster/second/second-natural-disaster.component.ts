...
export class SecondMeteorologicalDisasterComponent implements OnInit {
    ...
    async getNaturalDisastersDetail() {
        await this.dataService.getNaturalDisastersList(this.naturalEnum.Meteorological).subscribe(res => {
            this.dataInfo = res;
