...
import {CommanderInfoModel, PublicHealthListService} from 'src/app/services/biz-services/public-health-list.service';


@Component({
    selector: 'app-first-food-safety',
    templateUrl: './first-food-safety.component.html',
    styleUrls: ['./first-food-safety.component.less']
})
