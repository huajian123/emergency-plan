...
export class SecondPlagueControlComponent implements OnInit {
    ...
    async getPublicHealthDetail() {
        await this.dataService.getPublicHealthList(this.publicHealthEnum.PlagueControl).subscribe(res => {
            this.dataInfo = res;
