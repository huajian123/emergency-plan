...
export class SecondSpecialEquipmentComponent implements OnInit {
    ...
    async getAccidentDisastersDetail() {
        await this.dataService.getAccidentDisastersList(this.accidentEnum.SpecialEquipment).subscribe(res => {
            this.dataInfo = res;
