...
export class SecondCommunicationComponent implements OnInit {
    ...
    async getAccidentDisastersDetail() {
        await this.dataService.getAccidentDisastersList(this.accidentEnum.Communication).subscribe(res => {
            this.dataInfo = res;
