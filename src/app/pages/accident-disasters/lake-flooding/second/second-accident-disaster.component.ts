...
export class SecondLakeFloodingComponent implements OnInit {
    ...
    async getAccidentDisastersDetail() {
        await this.dataService.getAccidentDisastersList(this.accidentEnum.LakeFlooding).subscribe(res => {
            this.dataInfo = res;
