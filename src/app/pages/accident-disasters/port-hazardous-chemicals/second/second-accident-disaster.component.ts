...
export class SecondPortHazardousChemicalsComponent implements OnInit {
    ...
    async getAccidentDisastersDetail() {
        await this.dataService.getAccidentDisastersList(this.accidentEnum.PortHazardousChemicals).subscribe(res => {
            this.dataInfo = res;
