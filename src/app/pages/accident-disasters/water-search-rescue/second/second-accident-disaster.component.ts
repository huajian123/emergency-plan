...
export class SecondWaterSearchRescueComponent implements OnInit {
    ...
    async getAccidentDisastersDetail() {
        await this.dataService.getAccidentDisastersList(this.accidentEnum.WaterSearchRescue).subscribe(res => {
            this.dataInfo = res;
