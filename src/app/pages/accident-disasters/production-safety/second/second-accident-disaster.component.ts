...
export class SecondProductionSafetyComponent implements OnInit {
    ...
    async getAccidentDisastersDetail() {
        await this.dataService.getAccidentDisastersList(this.accidentEnum.ProductionSafety).subscribe(res => {
            this.dataInfo = res;
